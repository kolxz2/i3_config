...
const BaseSkeleton_1 = __webpack_require__(945);
const isAliexpressProductPage_1 = __webpack_require__(95);
const inject_1 = __webpack_require__(947);
const getInstalledDate_1 = __webpack_require__(77);
const inject_2 = __webpack_require__(347);
const actions_1 = __webpack_require__(24);
const ProductSkeleton_1 = __webpack_require__(949);
...
const init = async () => {
    ...
    port.onMessage.addListener(async (msg) => {
        ...
        if (msg.item) {
            ...
            const item = await utils_1.ChromeStorage.getItem((_c = msg === null || msg === void 0 ? void 0 : msg.item) === null || _c === void 0 ? void 0 : _c.id);
            if (item) {
...
const react_1 = __importDefault(__webpack_require__(0));
const S = __importStar(__webpack_require__(946));
...
exports.BaseSkeleton = styled_components_1.default.div.withConfig({ displayName: "BaseSkeleton", componentId: "sc-bjwsdj" }) `
	display: flex;
	height: 600px;
	overflow: hidden;
	position: relative;
...
const injectProductPopup_1 = __webpack_require__(948);
const popup_utils_1 = __webpack_require__(348);
...
const react_1 = __importDefault(__webpack_require__(0));
const S = __importStar(__webpack_require__(950));
...
exports.ProductSkeleton = void 0;
const styled_components_1 = __importDefault(__webpack_require__(3));
exports.ProductSkeleton = styled_components_1.default.div.withConfig({ displayName: "ProductSkeleton", componentId: "sc-4j8qqm" }) `
	display: flex;
	height: 600px;
	overflow: hidden;
	position: relative;
