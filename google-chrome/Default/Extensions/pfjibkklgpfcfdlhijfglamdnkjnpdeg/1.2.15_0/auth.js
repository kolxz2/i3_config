...
var Button_1 = __webpack_require__(965);
...
exports.PopupSuccess = styled_components_1.default.div.withConfig({ displayName: "PopupSuccess", componentId: "sc-skm0eq" }) `
	margin: 1.75em 0 2em;
	text-align: center;
...
const page_1 = __webpack_require__(957);
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Auth = void 0;
var Auth_1 = __webpack_require__(958);
...
const stores_1 = __webpack_require__(10);
const buttonClick_1 = __webpack_require__(183);
const typePopupOpen_1 = __webpack_require__(81);
const Platforms_1 = __webpack_require__(959);
const Form_1 = __webpack_require__(961);
const AuthWrapper_1 = __webpack_require__(970);
const SocialMediaLogin_1 = __webpack_require__(974);
const SuccessScreen_1 = __webpack_require__(976);
const SupportSuccess_1 = __webpack_require__(977);
const TypeSwitcher_1 = __webpack_require__(978);
...
const react_1 = __importDefault(__webpack_require__(0));
const react_i18next_1 = __webpack_require__(8);
const PlatformsLinks_1 = __webpack_require__(335);
const Platforms_styles_1 = __webpack_require__(960);
const Platforms = () => {
    const { t } = react_i18next_1.useTranslation();
...
exports.PopupBottom = styled_components_1.default.div.withConfig({ displayName: "PopupBottom", componentId: "sc-1lf9mhu" }) `
	align-items: center;
	...
	padding-top: 0.75em;
`;
exports.PopupBottomText = styled_components_1.default.span.withConfig({ displayName: "PopupBottomText", componentId: "sc-lf1hqe" }) `
	color: #474747;
	font-size: 0.875em;
	line-height: 1.3em;
`;
exports.PopupPlatforms = styled_components_1.default.div.withConfig({ displayName: "PopupPlatforms", componentId: "sc-jzf73z" }) `
	display: flex;
	justify-content: space-between;
	width: 9.35em;
`;
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Form = void 0;
var Form_1 = __webpack_require__(962);
...
const actions_1 = __webpack_require__(24);
const stores_1 = __webpack_require__(10);
const aliradar_1 = __webpack_require__(300);
const buttonClick_1 = __webpack_require__(183);
const error_1 = __webpack_require__(963);
const typePopupOpen_1 = __webpack_require__(81);
const S = __importStar(__webpack_require__(964));
const Button_1 = __webpack_require__(184);
const Checkbox_1 = __webpack_require__(967);
const Input_1 = __webpack_require__(968);
const Select_1 = __webpack_require__(969);
...
exports.FormAgreement = styled_components_1.default.div.withConfig({ displayName: "FormAgreement", componentId: "sc-16mgm2r" }) `
	...
	position: relative;
`;
exports.FormAgreementError = styled_components_1.default.div.withConfig({ displayName: "FormAgreementError", componentId: "sc-mdizav" }) `
	color: #f00;
	font-size: 14px;
	left: 15px;
	position: absolute;
	top: -1.65em;
`;
exports.FormButton = styled_components_1.default.div.withConfig({ displayName: "FormButton", componentId: "sc-9zklkf" }) `
...
`;
exports.FormCheckbox = styled_components_1.default.div.withConfig({ displayName: "FormCheckbox", componentId: "sc-i3gaad" }) `
	flex-grow: 1;
	margin-right: 0.9em;
`;
exports.FormColumn = styled_components_1.default.div.withConfig({ displayName: "FormColumn", componentId: "sc-txhiew" }) `
	width: 48.25%;
`;
exports.FormColumns = styled_components_1.default.div.withConfig({ displayName: "FormColumns", componentId: "sc-13fhuj1" }) `
	display: flex;
	justify-content: space-between;
`;
exports.FormLink = styled_components_1.default(Link_1.Link).attrs(() => ({
    target: '_blank'
})).withConfig({ displayName: "FormLink", componentId: "sc-comrn" }) `
    ...
    styled_components_1.css `
		...
		`}
`;
exports.FormNotification = styled_components_1.default.div.withConfig({ displayName: "FormNotification", componentId: "sc-13tqvq2" }) `
	line-height: 1.5em;
	margin: 2em 0;
	text-align: center;
`;
exports.FormText = styled_components_1.default.p.withConfig({ displayName: "FormText", componentId: "sc-14croa6" }) `
	color: #474747;
	margin: 0;
`;
...
const ButtonIcon = styled_components_1.default.span.withConfig({ displayName: "ButtonIcon", componentId: "sc-z1ceyh" }) `
	margin-right: 0.65em;
`;
...
exports.Button = void 0;
const styled_components_1 = __importStar(__webpack_require__(3));
exports.Button = styled_components_1.default.button.withConfig({ displayName: "Button", componentId: "sc-1fm8e8p" }) `
	align-items: center;
	border: none;
...
const styled_components_1 = __importStar(__webpack_require__(3));
const Icon_1 = __webpack_require__(83);
const Input = styled_components_1.default.input.withConfig({ displayName: "Input", componentId: "sc-650324" }) `
	appearance: none;
	height: 0;
	margin: 0;
	opacity: 0;
...
exports.Checkbox = styled_components_1.default(CheckboxEl).withConfig({ displayName: "Checkbox", componentId: "sc-19mjqll" }) `
	align-items: center;
...
const styled_components_1 = __importStar(__webpack_require__(3));
const Icon_1 = __webpack_require__(83);
const Checkmark = styled_components_1.default.div.withConfig({ displayName: "Checkmark", componentId: "sc-1u35cu" }) `
	margin: 0 1.2em 0 0.5em;
	position: absolute;
	right: ${({ margin }) => (margin ? '30px' : '0')};
`;
const Eye = styled_components_1.default.div.withConfig({ displayName: "Eye", componentId: "sc-mzb8el" }) `
	cursor: pointer;
	display: flex;
	margin-right: 0.9em;
	position: absolute;
	right: 0;
`;
const Field = styled_components_1.default.input.withConfig({ displayName: "Field", componentId: "sc-c0a8m9" }) `
	background: transparent;
	border: none;
	color: #141414;
	font-family: 'Open Sans', sans-serif;
    ...
    styled_components_1.css `
		...
		`}
`;
const Notification = styled_components_1.default.div.withConfig({ displayName: "Notification", componentId: "sc-3sn7h4" }) `
	color: #474747;
	font-size: 16px;
	left: 15px;
	opacity: 0.8;
...
`;
const Wrapper = styled_components_1.default.div.withConfig({ displayName: "Wrapper", componentId: "sc-137aazn" }) `
	align-items: center;
	background: #fafafa;
...
const react_1 = __importDefault(__webpack_require__(0));
const react_custom_scrollbars_1 = __webpack_require__(73);
const styled_components_1 = __importStar(__webpack_require__(3));
const Icon_1 = __webpack_require__(83);
const Arrow = styled_components_1.default.div.withConfig({ displayName: "Arrow", componentId: "sc-1k4jsx7" }) `
	align-items: center;
	cursor: pointer;
	display: flex;
	height: 100%;
	...
	width: 3.2em;
`;
const Field = styled_components_1.default.div.withConfig({ displayName: "Field", componentId: "sc-4azneb" }) `
	background: transparent;
	border: none;
	color: #50a2ff;
	cursor: pointer;
...
`;
const Option = styled_components_1.default.div.withConfig({ displayName: "Option", componentId: "sc-1wfhpov" }) `
	background: #fafafa;
	color: #323232;
	cursor: pointer;
	height: 3.3125em;
...
`;
const Options = styled_components_1.default.div.withConfig({ displayName: "Options", componentId: "sc-1pnvhbu" }) `
  ...
  `}
`;
const Wrapper = styled_components_1.default.div.withConfig({ displayName: "Wrapper", componentId: "sc-1rxwown" }) `
	align-items: center;
	background: #fafafa;
...
const react_1 = __importDefault(__webpack_require__(0));
const PopupSubtitle_1 = __webpack_require__(971);
const PopupTitle_1 = __webpack_require__(972);
const S = __importStar(__webpack_require__(973));
const clicker = {
    state: 0,
    onMouseDown: (e) => {
...
const H3 = styled_components_1.default.h3.withConfig({ displayName: "H3", componentId: "sc-2hv6rh" }) `
	font-size: 1em;
	font-weight: 400;
	line-height: 1.3em;
...
const H2 = styled_components_1.default.h2.withConfig({ displayName: "H2", componentId: "sc-xufl1t" }) `
	font-size: 1.125em;
	font-weight: 600;
	line-height: 1em;
	margin: 0;
...
const styled_components_1 = __importStar(__webpack_require__(3));
exports.AuthWrapper = styled_components_1.default.div.withConfig({ displayName: "AuthWrapper", componentId: "sc-1vl5xzy" }) `
	align-items: center;
...
`;
exports.Window = styled_components_1.default.div.withConfig({ displayName: "Window", componentId: "sc-1xwx55m" }) `
	background: #fff;
...
const vkLoginInit = () => {
    ...
    window.open(url, undefined, utils_1.serializeOptions({
        width,
        height,
        left,
        top
...
const fbLoginInit = () => {
    ...
    const left = (screen.width - width) / 2;
    const top = (screen.height - height) / 2;
    window.open(`${baseUrl}?${utils_1.serialize(query)}`, undefined, utils_1.serializeOptions({
        width,
        height,
        left,
        top
...
const SocialMediaLogin = () => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(S.PopupSocialButtons, null,
            react_1.default.createElement(S.PopupSocialButton, null,
        ...
        react_1.default.createElement(S.PopupSeparator, null,
            react_1.default.createElement(S.Separator, null, t('auth_or')))));
};
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Separator = exports.PopupSocialButtons = exports.PopupSocialButton = exports.PopupSeparator = void 0;
const styled_components_1 = __importDefault(__webpack_require__(3));
exports.PopupSeparator = styled_components_1.default.div.withConfig({ displayName: "PopupSeparator", componentId: "sc-1iujru6" }) `
	margin-bottom: 2.2em;
`;
exports.PopupSocialButton = styled_components_1.default.div.withConfig({ displayName: "PopupSocialButton", componentId: "sc-1rndutz" }) `
	width: 32%;
`;
exports.PopupSocialButtons = styled_components_1.default.div.withConfig({ displayName: "PopupSocialButtons", componentId: "sc-1ty0qrh" }) `
	display: flex;
	justify-content: space-between;
	margin: 2em 0 0.55em;
`;
exports.Separator = styled_components_1.default.div.withConfig({ displayName: "Separator", componentId: "sc-1xlr1ru" }) `
	align-items: center;
	display: flex;
	font-size: 1.125em;
	font-weight: 600;
...
const Button_1 = __webpack_require__(184);
const Icon_1 = __webpack_require__(83);
const PopupSuccess_1 = __webpack_require__(358);
...
const PopupInstructionLink = styled_components_1.default.a.withConfig({ displayName: "PopupInstructionLink", componentId: "sc-1yoej9t" }) `
	color: #50a2ff !important;
	font-weight: 700;
	text-decoration: none;
`;
const PopupSuccessImage = styled_components_1.default.div.withConfig({ displayName: "PopupSuccessImage", componentId: "sc-b7wtuy" }) `
	margin-bottom: 1.6em;
`;
const StyledButton = styled_components_1.default(Button_1.Button).withConfig({ displayName: "StyledButton", componentId: "sc-n7x8zj" }) `
	margin-bottom: 1.5em;
`;
...
const PopupTypeSwitcher = styled_components_1.default.button.withConfig({ displayName: "PopupTypeSwitcher", componentId: "sc-fyed5n" }) `
	background: transparent;
	border: none;
	color: #50a2ff;
	cursor: pointer;
...
`;
const PopupTypeSwitchers = styled_components_1.default.div.withConfig({ displayName: "PopupTypeSwitchers", componentId: "sc-w06yqx" }) `
	display: flex;
	flex-wrap: wrap;
